...
public class JnaTest {
    ...
    public static void getHandle() {
        System.setProperty("jna.library.path", "src/main/resources/dll");
        RnnLibrary.INSTANCE.setAdditionalPath("src/main/resources/dll");
        RnnLibrary.INSTANCE.setCudaVisibleDevices("0");
        System.setProperty("jna.debug_load", "true");
        pointer = RnnLibrary.INSTANCE.initializeHandleJava("src/main/resources/dll/config.ini");
    }
